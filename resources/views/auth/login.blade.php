...
@section('content')
<h1 class="text-3xl text-green-500 mb-6 text-center">Login</h1>
<form method="POST" action="{{ route('login') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <button type="submit" class="bg-green-500 text-white hover:bg-green-700 transition ease-in-out duration-500 rounded-md shadow-md w-full block px-4 py-2 mt-3">Connect</button>
</form>
@endsection